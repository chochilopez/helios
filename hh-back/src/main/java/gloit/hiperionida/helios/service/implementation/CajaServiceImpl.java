...
public class CajaServiceImpl implements CajaService {
    ...
    public CajaModel buscarPorIdConEliminadas(Long id) {
        ...
        log.info("Se encontro una entidad Caja con id: " + id + ", incluidas las eliminadas.");
        return cajaModel;
    }
    ...
    @Override
    public Slice<CajaModel> buscarTodasPorOrdenPorPagina(String direccion, String campo, int pagina, int elementos) {
    ...
    @Override
    public Slice<CajaModel> buscarTodasPorOrdenPorPaginaConEliminadas(String direccion, String campo, int pagina, int elementos) {
