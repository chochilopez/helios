...
public class NeumaticoServiceImpl implements NeumaticoService {
    ...
    public NeumaticoModel buscarPorId(Long id) {
        ...
        NeumaticoModel neumaticoModel = neumaticoDAO.findByIdAndEliminadaIsNull(id).orElseThrow(()-> new DatosInexistentesException("No se encontró la entidad Neumatico con id: " + id + "."));
    ...
    public NeumaticoModel buscarPorIdConEliminadas(Long id) {
        ...
        NeumaticoModel neumaticoModel = neumaticoDAO.findById(id).orElseThrow(()-> new DatosInexistentesException("No se encontró la entidad Neumatico con id: " + id +", incluidas las eliminadas."));
