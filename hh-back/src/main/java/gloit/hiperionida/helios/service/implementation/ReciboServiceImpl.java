...
public class ReciboServiceImpl implements ReciboService {
    ...
    public ReciboModel buscarPorIdConEliminadas(Long id) {
        ...
        log.info("Se encontro una entidad Recibo con id: " + id + ", incluidas las eliminadas.");
        return reciboModel;
    }
    ...
    public List<ReciboModel> buscarTodas() {
        ...
        if (listado.isEmpty())
            throw new DatosInexistentesException("No se encontraron entidades Recibo.");
        return listado;
    }
    ...
    public List<ReciboModel> buscarTodasConEliminadas() {
        ...
        if (listado.isEmpty())
            throw new DatosInexistentesException("No se encontraron entidades Recibo, incluidas las eliminadas.");
        return listado;
    }
