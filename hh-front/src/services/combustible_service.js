...
function obtenerTodas () {
  return llavero.obtenerDeLocal('lCombustibleTodas')
}

function obtenerTodasConEliminadas () {
  return llavero.obtenerDeLocal('lCombustibleTodasConEliminadas')
}

function obtenerPorId (id) {
  return llavero.obtenerDeLocal('lCombustiblePorId/' + id + '/')
}

function obtenerPorIdConEliminadas (id) {
  return llavero.obtenerDeLocal('lCombustiblePorIdConEliminadas/' + id + '/')
}

function obtenerCuenta () {
  return llavero.obtenerDeLocal('lCombustibleCuenta')
}

function obtenerCuentaConEliminadas () {
  return llavero.obtenerDeLocal('lCombustibleCuentaConEliminadas')
}
...
function spfBuscarTodas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/buscar-todas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lCombustibleTodas', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarTodasConEliminadas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/buscar-todas-con-eliminadas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lCombustibleTodasConEliminadas', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarTodasPaginadas (paginadoDTO) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/buscar-todas-paginadas', paginadoDTO, {
      headers: {
        Authorization: 'Bearer ' + autenticacionService.obtenerToken()
      }
    })
...
function spfBuscarTodasConEliminadasPaginadas (paginadoDTO) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/buscar-todas-paginadas-con-eliminadas', paginadoDTO, {
      headers: {
        Authorization: 'Bearer ' + autenticacionService.obtenerToken()
      }
    })
...
function spfBuscarPorId (id) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/buscar-por-id/' + id, {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lCombustiblePorId/' + id + '/', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarPorIdConEliminadas (id) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/buscar-por-id-con-eliminadas/' + id, {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lCombustiblePorIdConEliminadas/' + id + '/', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfContarTodas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/contar-todas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lCombustibleContar', result, ttlEnum.TTL_1_DIA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfContarTodasConEliminadas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'combustible/contar-todas-con-eliminadas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lCombustibleContarConEliminadas', result, ttlEnum.TTL_1_DIA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfReciclar (id) {
  return new Promise((resolve, reject) => {
    axios.post(API_URL + 'combustible/reciclar/' + id, {
      headers: {
        Authorization: 'Bearer ' + autenticacionService.obtenerToken()
      }
    })
