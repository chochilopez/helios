...
function obtenerTodas () {
  return llavero.obtenerDeLocal('lPresupuestoTodas')
}

function obtenerTodasConEliminadas () {
  return llavero.obtenerDeLocal('lPresupuestoTodasConEliminadas')
}

function obtenerPorId (id) {
  return llavero.obtenerDeLocal('lPresupuestoPorId/' + id + '/')
}

function obtenerPorIdConEliminadas (id) {
  return llavero.obtenerDeLocal('lPresupuestoPorIdConEliminadas/' + id + '/')
}

function obtenerCuenta () {
  return llavero.obtenerDeLocal('lPresupuestoCuenta')
}

function obtenerCuentaConEliminadas () {
  return llavero.obtenerDeLocal('lPresupuestoCuentaConEliminadas')
}
...
function spfBuscarTodas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/buscar-todas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lPresupuestoTodas', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarTodasConEliminadas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/buscar-todas-con-eliminadas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lPresupuestoTodasConEliminadas', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarTodasPaginadas (paginadoDTO) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/buscar-todas-paginadas', paginadoDTO, {
      headers: {
        Authorization: 'Bearer ' + autenticacionService.obtenerToken()
      }
    })
...
function spfBuscarTodasConEliminadasPaginadas (paginadoDTO) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/buscar-todas-paginadas-con-eliminadas', paginadoDTO, {
      headers: {
        Authorization: 'Bearer ' + autenticacionService.obtenerToken()
      }
    })
...
function spfBuscarPorId (id) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/buscar-por-id/' + id, {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lPresupuestoPorId/' + id + '/', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarPorIdConEliminadas (id) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/buscar-por-id-con-eliminadas/' + id, {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lPresupuestoPorIdConEliminadas/' + id + '/', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfContarTodas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/contar-todas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lPresupuestoContar', result, ttlEnum.TTL_1_DIA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfContarTodasConEliminadas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'presupuesto/contar-todas-con-eliminadas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lPresupuestoContarConEliminadas', result, ttlEnum.TTL_1_DIA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
