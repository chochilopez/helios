...
function obtenerTodas () {
  return llavero.obtenerDeLocal('lUbicacionTodas')
}

function obtenerTodasConEliminadas () {
  return llavero.obtenerDeLocal('lUbicacionTodasConEliminadas')
}

function obtenerPorId (id) {
  return llavero.obtenerDeLocal('lUbicacionPorId/' + id + '/')
}

function obtenerPorIdConEliminadas (id) {
  return llavero.obtenerDeLocal('lUbicacionPorIdConEliminadas/' + id + '/')
}

function obtenerCuenta () {
  return llavero.obtenerDeLocal('lUbicacionCuenta')
}

function obtenerCuentaConEliminadas () {
  return llavero.obtenerDeLocal('lUbicacionCuentaConEliminadas')
}
...
function spfBuscarTodas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/buscar-todas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lUbicacionTodas', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarTodasConEliminadas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/buscar-todas-con-eliminadas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lUbicacionTodasConEliminadas', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarTodasPaginadas (paginadoDTO) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/buscar-todas-paginadas', paginadoDTO, {
      headers: {
        Authorization: 'Bearer ' + autenticacionService.obtenerToken()
      }
    })
...
function spfBuscarTodasConEliminadasPaginadas (paginadoDTO) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/buscar-todas-paginadas-con-eliminadas', paginadoDTO, {
      headers: {
        Authorization: 'Bearer ' + autenticacionService.obtenerToken()
      }
    })
...
function spfBuscarPorId (id) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/buscar-por-id/' + id, {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lUbicacionPorId/' + id + '/', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfBuscarPorIdConEliminadas (id) {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/buscar-por-id-con-eliminadas/' + id, {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lUbicacionPorIdConEliminadas/' + id + '/', result, ttlEnum.TTL_1_HORA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfContarTodas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/contar-todas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lUbicacionContar', result, ttlEnum.TTL_1_DIA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
...
function spfContarTodasConEliminadas () {
  return new Promise((resolve, reject) => {
    axios.get(API_URL + 'ubicacion/contar-todas-con-eliminadas', {
      ...
      .then((result) => {
        llavero.guardarEnLocal('lUbicacionContarConEliminadas', result, ttlEnum.TTL_1_DIA)
        resolve(result)
      })
      .catch((error) => {
        reject(error)
